<?php
/**
 * Template Name: Nghĩa vụ thành viên Cộng Đồng
 * Hiển thị danh sách bài Nghĩa vụ thành viên Cộng Đồng (tiêu đề + hình + mô tả); bấm vào mở accordion nội dung bên trong.
 */

get_header();

$args = array(
    'post_type'      => 'nghia_vu_thanh_vien',
    'posts_per_page' => -1,
    'post_status'    => 'publish',
...
<h1 class="cd-detail__title"><?php the_title(); ?></h1>
                ...
                <?php else : ?>
                    <p class="no-items-message">Chưa có bài nào trong mục này. Vui lòng thêm bài tại <strong>Nghĩa vụ thành viên Cộng Đồng</strong> trong menu quản trị.</p>
                <?php endif; ?>
